...
public class GerenciadorQuarto {
    ...
    public List<Quarto> buscarQuartos(BuscarQuarto buscarQuarto, Map<Periodo, Quarto> reservas, List<Quarto> todosQuartos) throws DateTimeParseException, IllegalArgumentException {
