...
public class Main {
    public static void main(String[] args) {
        ...
        Quarto quarto6 = new Quarto(true, 6,90.00);
        Quarto quarto7 = new Quarto(true, 7,90.00);
        Quarto quarto8 = new Quarto(true, 8,90.00);
        Quarto quarto9 = new Quarto(true, 9,90.00);
        ...
        listaDeQuartos.add(quarto6);
        listaDeQuartos.add(quarto7);
        listaDeQuartos.add(quarto8);
        listaDeQuartos.add(quarto9);
